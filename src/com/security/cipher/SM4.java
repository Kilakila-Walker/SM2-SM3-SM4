...
public class SM4 
{
	...
	public static final long[] FK = { 0xa3b1bac6, 0x56aa3350, 0x677d9197, 0xb27022dc };
	
	public static final long[] CK = { 0x00070e15,0x1c232a31,0x383f464d,0x545b6269,
	...
	public void sm4_setkey_enc(SM4Context ctx, byte[] key) throws Exception
	{
		...
		{
			throw new Exception("密码需为16位“纯英文”字符");
		}
	...
	public byte[] sm4_crypt_cbc(SM4Context ctx, byte[] iv, byte[] input) throws Exception
	{
		...
		{
			throw new Exception("IV需为16位“纯英文”字符!");
		}
