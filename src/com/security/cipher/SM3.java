...
public class SM3 
{
	...
	protected static byte[] CF(byte[] V, byte[] B) 
	{
		int[] v, b;
		v = convert(V);
		b = convert(B);
	...
	protected static int[] convert(byte[] arr)
	{
	...
	protected static byte[] convert(int[] arr) 
	{
	...
	protected static int[] CF(int[] V, int[] B) 
	{
		int a, b, c, d, e, f, g, h;
		int ss1, ss2, tt1, tt2;
		a = V[0];
	 ...
	 * @return
	 */
	protected static byte[] padding(byte[] in, int bLen)
	{
